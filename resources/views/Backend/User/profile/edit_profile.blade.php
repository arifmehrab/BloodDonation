                ...
                <div class="col-md-12 col-sm-12" id="regi_form_design">
                     <div id="register_form">
                         <form action="{{ route('user.update.profile') }}" method="POST" enctype="multipart/form-data">
                             ...
                             <div class="form-row">
                                 <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <label for="profile">Update Profile (Image size Maximum 2MV) <strong style="color: red;">*</strong></label>
                                        <div class="custom-file mb-3">
                                            <input name="profile" type="file" class="form-control" id="profile" onchange="readURL(this)" required>
                                        </div>
                                            <!--- Error Message -->
                                            @error('profile')
                             ...
                             <button id="Profile" type="submit" class="btn btn-primary btn-block btn-sm">Update</button>
